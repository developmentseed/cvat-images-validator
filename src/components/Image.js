...
import Box from './Box';
const rgbColors = ['128,0,128', '255,0,0', '0,0,255', '0,128,0', '255,255,153', '128,0,0', '255,105,180', '50,205,50'];
        ...
        return (
            <div className="imgContainer">
                <Stage
                    ...
                    onClick={this.open} >
                    {boxes ? boxes.map((box,i) => <Box boxProp={box} key={`${this.props.image.attributes.id}-box-${i}`}layerWidth={layerWidth} layerHeight={layerWidth} imgAtrr={imgAtrr} color={rgbColors[i]} />) : ''}
                </Stage>
